...
It provides clients to interact with a CCF network.
"""
...
from .commit import wait_for_commit
from .log_capture import flush_info
...
class Identity:
    """
    Identity (as private key and corresponding certificate) for a :py:class:`CCFClient` client.
    """
...
class Response:
    """
    Response to request sent via :py:class:`CCFClient`
    """
...
class CCFConnectionException(Exception):
    """
    Exception raised if a :py:class:`CCFClient` instance cannot successfully establish
...
class CCFIOException(Exception):
    """
    Exception raised if a :py:class:`CCFClient` instance experiences a fatal error when
...
class CCFClient:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.hostname = make_address(host, port)
    ...
    def wait_for_commit(
        ...
        """
        Given a :py:class:`Response`, this functions waits
        ...
        :param Response response: Response returned by :py:meth:`CCFClient.call`
        ...
        wait_for_commit(self, response.seqno, response.view, timeout)
