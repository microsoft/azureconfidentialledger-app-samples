...
import attestation_service_pb2 as attestation__service__pb2
...
class AttestationContainerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FetchAttestation = channel.unary_unary(
            ...
            request_serializer=attestation__service__pb2.FetchAttestationRequest.SerializeToString,
            response_deserializer=attestation__service__pb2.FetchAttestationReply.FromString,
        )
...
def add_AttestationContainerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "FetchAttestation": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=attestation__service__pb2.FetchAttestationRequest.FromString,
            response_serializer=attestation__service__pb2.FetchAttestationReply.SerializeToString,
        ),
    }
...
class AttestationContainer(object):
    ...
    def FetchAttestation(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/attestation_container.AttestationContainer/FetchAttestation",
            attestation__service__pb2.FetchAttestationRequest.SerializeToString,
            attestation__service__pb2.FetchAttestationReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
