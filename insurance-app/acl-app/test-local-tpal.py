...
parser.add_argument('--processor-privk', type=str, help="Processor's private key")
parser.add_argument('--processor-cert', type=str, help="Processor's cert")
...
if __name__ == "__main__":
  ...
  with tempfile.NamedTemporaryFile("w", suffix=".pem") as client_privk_file, \
    ...
    processor_identity = test_harness._get_cert_identity(args.processor_cert, args.processor_privk)
