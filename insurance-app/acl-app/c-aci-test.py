  ...
  with tempfile.NamedTemporaryFile("w", suffix=".pem") as client_privk_file, \
    ...
    with tester.client_set(
      ...
      admin_client.put(
        ...
        body=
        {
          "uvm_endorsements":{"did":"did:x509:0:sha256:I__iuL25oXEVFdTP_aBLx_eT1RPHbCQ_ECBQfYZpt9s::eku:1.3.6.1.4.1.311.76.59.1.2","feed":"ContainerPlat-AMD-UVM","svn":"101"},"measurement":["GCWkvyqcODVmpxdjJoOawONqHFs36eb6vI/dcTDVjO9W9DR1ArlHiVMM7BmKpRVD"],"policy":["CRuchmyAFMAfGtMc0ivF0IBi/tHgXx/1cRMcvsHIWfs="]}
        ,
        headers={"content-type": "application/json"}
      )
